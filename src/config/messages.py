...
Если вы не можете в какой то день прийти на занятие, то можете его либо отменить, либо перенести - бот предложит свободные дни и время.

Время в боте всегда указано по МСК.

Каждый день утром по МСК бот присылает напоминание о предстоящем занятии.
Эта команда обновляет клавиатуру с кнопками.
"""
GREETINGS = "你好, %s!"
CANCELED = "Отмена"
