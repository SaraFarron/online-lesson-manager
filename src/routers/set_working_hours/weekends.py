...
@log_func
async def remove_weekend(callback: CallbackQuery, state: FSMContext, db: Session) -> None:
...
@log_func
async def add_weekend(callback: CallbackQuery, state: FSMContext, db: Session) -> None:
...
@log_func
async def add_weekend_finish(callback: CallbackQuery, state: FSMContext, db: Session) -> None:
